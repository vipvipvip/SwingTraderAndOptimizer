...
echo ""
echo "  # Weekly EW ETF rebalance trigger (every 5 min; command day-gates to rebalance day)"
echo "  */5 * * * * /usr/bin/php $PROJECT_ROOT/backend/artisan trades:execute-EW-ETF >> /dev/null 2>&1"
echo ""
