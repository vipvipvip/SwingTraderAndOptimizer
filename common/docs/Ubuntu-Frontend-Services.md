...
Type=simple
User=dikesh
WorkingDirectory=/home/dikesh/data/dev/SwingTraderAndOptimizer/swingtrader/frontend
...
```bash
cd /home/dikesh/data/dev/SwingTraderAndOptimizer/swingtrader/frontend
npm run build
```
...
server {
    ...
    root /home/dikesh/data/dev/SwingTraderAndOptimizer/swingtrader/frontend/dist;
    index index.html;
