...
<div class="top-bar">
  ...
  <select id="modeSelect" onchange="switchMode(this.value)">
    <option value="stock" <?php echo e($mode == 'stock' ? 'selected' : ''); ?>>Stocks</option>
    <option value="etf" <?php echo e($mode == 'etf' ? 'selected' : ''); ?>>ETFs</option>
  </select>
  <div class="divider"></div>
...
<?php /**PATH /home/dikesh/data/dev/SwingTraderAndOptimizer/scanner/backend/views/scanner/explorer.blade.php ENDPATH**/ ?>